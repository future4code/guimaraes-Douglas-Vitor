...
const App = () => {
  ...
  const carregaPerfil = () => {
    ...
    axios
    .get("https://us-central1-missao-newton.cloudfunctions.net/astroMatch/well-sotero/person")
    .then(resposta=>{
  ...
  const carregaLista = () =>{
    axios
    .get("https://us-central1-missao-newton.cloudfunctions.net/astroMatch/well-sotero/matches")
    .then(resposta =>{
  ...
  const limparSwipes = () => {
    axios
      .put("https://us-central1-missao-newton.cloudfunctions.net/astroMatch/well-sotero/clear")
      .then(resposta =>{
